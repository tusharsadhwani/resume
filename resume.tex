...
~~~% ~ for padding. copy these two lines to align text around bullets.
...
\section{Experience}
\runsubsection{\href{https://deepsource.io}{DeepSource}}
\descript{| Language Engineer Intern}
\location{July 2021 - Present | San Francisco, CA}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Working on \textbf{Static Analyzers} in Python, used to automatically detect and issue software fixes to the clients.
\end{tightemize}
\sectionsep
...
\descript{| \href{https://github.com/tusharsadhwani/python_snippets}{\textbf{Github}} | \href{https://snippets.live}{\textbf{Live Demo}}}
